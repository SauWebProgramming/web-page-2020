...
using Microsoft.AspNetCore.Authorization; //authorize işlemlerinin algılanabilmesi için
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel loginViewModel)
        {
            ...
            if (user != null)
            {
                ...
                if (result.Succeeded)  //sonucun başarılı olup olmama kontrolü
                {
        ...
        [HttpPost]
        [Authorize]  //Sadece Giriş yapan kullanıcılar çıkış yapabilecek
